...
public class ForegroundBinderManager {
    ...
    public void init(BinderPool binderPool) {
        ...
        try {
            ...
            mBinderPool.registerObserver(IPlayMusicChangeObserverImpl.getInstance(), Constant.BinderPoolCode.BINDER_POOL_MUSIC_CHANGE_OBSERVER);
    ...
    public void release() {
        try {
            ...
            mBinderPool.unregisterObserver(IPlayMusicChangeObserverImpl.getInstance(), Constant.BinderPoolCode.BINDER_POOL_MUSIC_CHANGE_OBSERVER);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
        mBinderPool = null;
